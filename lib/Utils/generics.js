...
const generateMessageID = () => (0, crypto_1.randomBytes)(8).toString('hex').toUpperCase();
...
const fetchLatestBaileysVersion = async (options = {}) => {
    const URL = 'https://raw.githubusercontent.com/adjidev/baileyspp/master/src/Defaults/baileys-version.json';
    try {
