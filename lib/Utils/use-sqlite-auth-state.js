...
const useSQLiteAuthState = async (config, tableName = 'auth_state') => {
    ...
    const finalTableName = typeof config === 'string' ? tableName : (config === null || config === void 0 ? void 0 : config.tableName) || 'auth_state';
    ...
    const readData = async (key) => {
        ...
        if (!(row === null || row === void 0 ? void 0 : row.data)) return null;
